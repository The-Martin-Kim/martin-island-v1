                            ...
                            <Card.Text as="div">
                                <ul className="list-unstyled" style={{textAlign: 'left', paddingLeft: '20px'}}>
                                    <li>
                                        ...
                                        모교에서의 대회 수상(창의력 대회, SW 공모대회, SW 교육 컨텐츠 대회 등) 이력과 학생부 종합전형 중심의 학교 생활 경험을 바탕으로
                                        현재까지도 많은 중·고등학생의 교내/외 대회 및 수행평가 관련 활동을 지도하고 있습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 2019년도부터 대치동
                                        소재의 진학입시교육학원에서 입시 담당 선생님으로 재직하며 생활기록부 관련 지도와 자기소개서 첨삭, 면접 수업 진행 등의 여러 대입 관련 업무를
                                        도맡아 왔습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 인공지능(AI)을 전공하였으며,
                                        Financial Data Science Lab. 에서의 연구 활동과 IT 플랫폼 탐구·개발 자율동아리 창설 및 운영 경험이 있습니다.
                                    </li>
                                    <br/>
                                    <li>
                                        <span style={{display: 'inline-block', width: '1em'}}>▷</span> 대학교에서는 SW중심대학
                                    ...
                                    <li>
                                        ...
                                        Data Analysis 등의 프로그래밍 수업과 AP Computer Science, USACO 등의 유학생 SW 수업, 또 대입 면접 수업을
                                        진행하고 있습니다.
                                    </li>
                                    <br/>
                                    <li>
